...
**实体技能系统（一切皆为技能）**:
- 当你创建一个实体时，AI会自动分析并赋予其合适的技能/性格
- creature技能类型:
  - 行动技能: 移动, 觅食, 饮水, 思考, 睡觉, 攻击, 逃跑
  - 性格: 善良, 易怒, 窝囊, 勇敢, 胆怯, 忠诚, 奸诈, 好奇, 冷漠, 热情, 害羞, 开朗, 悲观, 乐观
  - 习性: 领地意识, 群居, 独居, 护食, 好斗, 温顺
- plant: 生长, 光合作用, 扎根, 有毒, 药用, 可食用
- fire: 蔓延, 燃烧, 熄灭, 高温
- water: 流动, 蒸发, 冻结, 饮用
- building: 存储, 居住, 防御, 标志性
- resource: 开采, 再生, 稀缺, 珍贵
...
class Agent:
    ...
    def _analyze_skills(self, entity_type: str, entity_name: str) -> List[str]:
        skill_options = {
            "creature": [
                "移动", "觅食", "饮水", "思考", "睡觉", "攻击", "逃跑",
                "善良", "易怒", "窝囊", "勇敢", "胆怯", "忠诚", "奸诈",
                "好奇", "冷漠", "热情", "害羞", "开朗", "悲观", "乐观",
                "领地意识", "群居", "独居", "护食", "好斗", "温顺"
            ],
            "plant": ["生长", "光合作用", "扎根", "有毒", "药用", "可食用"],
            "fire": ["蔓延", "燃烧", "熄灭", "高温"],
            "water": ["流动", "蒸发", "冻结", "饮用", "可燃"],
            "building": ["存储", "居住", "防御", "标志性"],
            "resource": ["开采", "再生", "稀缺", "珍贵"]
        }
...
只需要返回4-8个最合适的技能/性格，用逗号分隔。如果不确定，返回"善良,温顺"。"""
